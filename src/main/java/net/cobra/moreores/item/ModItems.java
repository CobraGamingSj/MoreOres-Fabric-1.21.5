...
public class ModItems {
    ...
    public static final Item FERRARI_KEY = register("ferrari_key", new CarKeyItem(new Item.Settings().maxCount(1).registryKey(RegistryKey.of(RegistryKeys.ITEM, getId("ferrari_key"))), 2, ModCarEntities.FERRARI));
    ...
    public static final Item KYAWTHUITE = register("kyawthuite", new Item(new Item.Settings().fireproof().trimMaterial(ModArmorTrimMaterials.KYAWTHUITE).rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, getId("kyawthuite")))));
    public static final Item RAW_KYAWTHUITE = register("raw_kyawthuite", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, getId("raw_kyawthuite")))));
